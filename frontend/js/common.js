...
function getDefaultSettings() {
  // Auto-detect backend URL based on deployment environment
  let defaultBackendUrl = 'http://127.0.0.1:5000';
  
  // If not running on localhost, use the same origin as the frontend
